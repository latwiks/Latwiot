module.exports = {
    ...
    code(cache) {
        ...
        const custom_prefix = this.GetInputValue("prefix", cache, true);
        ...
        const EndBlock = (msg, reason, action) => {
            ...
            msg.member ? this.StoreOutputValue(msg.member.voice.channel, "vc", cache) : undefined
