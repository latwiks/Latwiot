module.exports = {
    ...
    description: "Create a message button. This Block is made by @JU & @EXCORDO, fixed by Beastlybear2017",
    ...
    async code(cache) {
		const { MessageButton } = await this.require('discord-buttons-fixed');
